...
///\defgroup ms8101 MS8101-7實作
///依據材戶8101-7的實作
///@{

///參照ms8101-7 10.3.1.1.4
#define TO_VIDEO_T    0x0
#define TO_AUDIO_T    0x1
#define TO_PICTURE_T  0x2
#define TO_CONFIG_8_T 0xa
#define TO_CONFIG_4_T 0xb
#define TO_TIME_T     0xc
#define TO_CONFIG_1_T 0xd
#define TO_EVENT_T    0xe
#define TO_SDP_T      0xf
...
// cmd 255-511 legacy ipcam command
///參照ms8101-7 10.3.2.1.4
...
///參照ms8101-7 10.3.2.3的Command No.
...
///
///由於camid欄位長度不固定，EVENT_PACKET拆解成兩段：Event_PACKET_Part1和Event_PACKET_Part2<br>
///資料接收完畢後，呼叫SET_PACKET_CAMID_END_AND_LINK_PART2，即可把Event_PACKET_Part2接上Event_PACKET_Part1後<br>
///參照ms8101-7 10.3.1.3
struct Event_PACKET_Part1
{
	U8 Event_Keyword[9];
